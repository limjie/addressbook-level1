...
public class AddressBook {
    ...
    private static String executeEditPerson(String commandArgs) {
        ...
        return editPersonFromAddressBook(targetInModel, commandArgs)
    ...
    private static String getMessageForFormattedPersonData(String[] person) {
        return String.format(MESSAGE_DISPLAY_PERSON_DATA, getNameFromPerson(person),
                getPhoneFromPerson(person), getEmailFromPerson(person), getDOBfromPerson(person));
    }
    ...
    private static String extractDOBFromPersonString(String encoded) {
        ...
        if (indexOfDOBPrefix > indexOfPhonePrefix && indexOfDOBPrefix > indexOfEmailPrefix) {
            ...
            return removePrefixSign(encoded.substring(indexOfDOBPrefix, nextIndex).trim(),
                    PERSON_DATA_PREFIX_DOB);
        }
    }
    ...
    private static String extractPhoneFromPersonString(String encoded) {
        ...
        if (indexOfPhonePrefix > indexOfEmailPrefix && indexOfPhonePrefix > indexOfDOBPrefix) {
            ...
            return removePrefixSign(encoded.substring(indexOfPhonePrefix, nextIndex).trim(),
                    PERSON_DATA_PREFIX_PHONE);
        }
    }
    ...
    private static String extractEmailFromPersonString(String encoded) {
        ...
        if (indexOfEmailPrefix > indexOfPhonePrefix && indexOfEmailPrefix > indexOfDOBPrefix) {
            ...
            return removePrefixSign(encoded.substring(indexOfEmailPrefix, nextIndex).trim(),
                    PERSON_DATA_PREFIX_EMAIL);
        }
    }
    ...
    private static String getUsageInfoForAllCommands() {
        return getUsageInfoForAddCommand() + LS + getUsageInfoForFindCommand() + LS
                ...
                + getUsageInfoForHelpCommand() + LS + getUsageInfoForSortCommand() + LS
